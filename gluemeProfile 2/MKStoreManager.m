...
static NSString *featureAId = @"com.endeavor.thelovecop2.id2";
static NSString *featureBId = @"com.SAR.comegetme.point";
static NSString *featureCId = @"com.endeavor.thelovecop2.id1";
...
- (void) requestProductData
{
	SKProductsRequest *request= [[SKProductsRequest alloc] initWithProductIdentifiers: 
								 [NSSet setWithObjects: featureAId, featureBId,featureCId, nil]];
...
- (void)productsRequest:(SKProductsRequest *)request didReceiveResponse:(SKProductsResponse *)response
{
	...
	// populate UI
	NSLog(@"%@",[purchasableObjects description]);
